...
const SignUp = () => {
    ...
    const { signInUsignGoogle, signInFacebook, signInUsignGithub, handleCreateNewUser, error, setError, setIsLoading, setUserName } = allContext || {};

    // form destuctruring
    const { register, handleSubmit, formState: { errors } } = useForm();
    const onSubmit = data => handleSignUpEmailPass(data?.email, data?.password);
            ...
            <Container>
                <Row>
                    <div className="form-field">
                        ...
                        <button className="signin-btn" onClick={handleSignInGoogle}>
                        ...
                        <button className="signin-btn" onClick={handleSignInFacebook}>
                        ...
                        <button className="signin-btn" onClick={handleSignInGithub}><FontAwesomeIcon className="github-icon" icon={faGithub} /></button>
                    </div>
                </Row>
            </Container>
        </div>
